...
import static com.github.nikolaiKorenev99.software_reengineering_and_verification.module_test_1.Item.Type.*;
...
public class ShoppingCart {
    ...
    public static void main(String[] args) {
        ...
        cart.addItem("Apple", 0.99, 5, REGULAR);
        cart.addItem("Banana", 20.00, 4, DISCOUNT);
        cart.addItem("A long piece of toilet paper", 17.20, 1, SALE);
        cart.addItem("Nails", 2.00, 500, REGULAR);
    ...
    public void addItem(String title, double price, int quantity, Item.Type type) {
        ...
        Item item = new Item(title, price, type, quantity);
        items.add(item);
    }
