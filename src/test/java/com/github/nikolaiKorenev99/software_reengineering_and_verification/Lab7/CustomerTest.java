...
public class CustomerTest {
    ...
    public void testPrintCustomerMoney() throws Exception {
        Customer customer = getPersonWithAccount(false);
        assertThat(customer.account.printCustomerMoney(customer), is("danix dan Account: IBAN: RO023INGB434321431241, Money: 34.0"));
    }
    ...
    private Customer getPersonWithAccount(boolean premium) {
        Account.AccountType accountType = new Account.AccountType(premium);
